...
| `MOCK_INVALID_RESPONSE_FISCAL_CODE` | Fiscal code that triggers a malformed/invalid JSON 400 response from the mock (MOCKSP04) |
...
| `MOCK_INVALID_RESPONSE_FISCAL_CODE_V2` | V2 - Fiscal code that triggers a malformed/invalid JSON 400 response from the mock (MOCKSP05) |
