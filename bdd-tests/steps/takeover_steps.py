...
def when_sp_b_attempts_activation(context, role, debtor_name):
    ...
    activation_response = activate(
        context.access_tokens["debtor_b"], debtor_fc, secrets.debtor_service_provider_B.service_provider_id
    )
...
def when_sp_b_performs_takeover(context, role, debtor_name):
    ...
    takeover_response = takeover_activation(
        context.access_tokens["debtor_b"], debtor_fc, secrets.debtor_service_provider_B.service_provider_id, context.otp
    )
...
def when_sp_b_attempts_with_invalid_otp(context, role, debtor_name):
    ...
    takeover_response = takeover_activation(
        context.access_tokens["debtor_b"], debtor_fc, secrets.debtor_service_provider_B.service_provider_id, invalid_otp
    )
