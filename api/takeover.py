...
def takeover_activation(access_token: str, payer_fiscal_code: str, service_provider_id: str, otp: str = None):
    """API to takeover an activation from one service provider to another
    
    :param access_token: The authentication token
    :param activation_id: The ID of the activation to takeover
