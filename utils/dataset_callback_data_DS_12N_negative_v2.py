"""Utility to generate DS-12N negative (RJCR) RFC callback payloads for v2 callback tests.

The generated payload mimics the v2 callback sent for a SEPA Request-to-Pay
Cancellation Response with a RJCR (Rejected Cancellation Request) status,
indicating that the cancellation request has been rejected and the RTP
transitions to CANCELLED_REJECTED.
"""
...
RJCR_TX_CXL_STATUS = "RJCR"
ARJR_REASON_CODE = "ARJR"
ASSIGNOR_BIC = "ANYBICXXXXX"


def generate_callback_data_DS_12N_negative_compliant(
    bic: str = DEBTOR_SERVICE_PROVIDER_C_ID,
    resource_id: str | None = None,
    original_msg_id: str | None = None,
    assignee_bic: str | None = None,
) -> JsonType:
    """Generate a DS-12N RJCR compliant RFC callback payload (v2).
    ...
    Returns:
        JsonType: JSON-serializable DS-12N RJCR compliant callback payload,
...
def generate_non_compliant_callback_data_DS_12N_negative(
    bic: str = DEBTOR_SERVICE_PROVIDER_C_ID,
    resource_id: str | None = None,
    original_msg_id: str | None = None,
    assignee_bic: str | None = None,
) -> JsonType:
    """Generate a DS-12N non-compliant RFC callback payload (v2).
    ...
    Returns:
        JsonType: JSON-serializable DS-12N callback payload with invalid
                ...
                "RsltnOfInvstgtn": {
                    ...
                    "CxlDtls": {
                        "TxInfAndSts": {
                            ...
                            "OrgnlTxId": tx_id,
                            "TxCxlSts": RJCR_TX_CXL_STATUS,
                            "CxlStsRsnInf": {
                                "Orgtr": {"Id": {"OrgId": {"AnyBIC": ASSIGNOR_BIC}}},
                                "Rsn": {"Cd": ARJR_REASON_CODE},
                            },
                            "OrgnlTxRef": {
                                "Amt": {"InstdAmt": amount},
