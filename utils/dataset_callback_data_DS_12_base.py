...
from .datetime_utils import generate_create_time, generate_execution_date


def generate_rfc_callback_data(
    status: str, bic: str = "MOCKSP04", resource_id: str = None, original_msg_id: str = None, assignee_bic: str = None
) -> JsonType:
            ...
            "Document": {
                "RsltnOfInvstgtn": {
                    "Assgnmt": {
                        ...
                        "Assgnr": {
                            "Pty": {"Id": {"OrgId": {"Othr": [{"Id": creditor_id, "SchmeNm": {"Cd": "BOID"}}]}}}
                        },
                        "CreDtTm": create_time,
                        "Id": message_id,
                    },
                        ...
                        "TxInfAndSts": [
                            {
                                ...
                                "CxlStsRsnInf": [
                                    {
                                        "AddtlInf": [f"ATS005/ {execution_date}"],
                                ...
                                "OrgnlTxRef": {
                                    ...
                                    "Cdtr": {
                                        "Pty": {
                                            "Id": {"OrgId": {"Othr": [{"Id": creditor_id, "SchmeNm": {"Cd": "BOID"}}]}},
                                            "Nm": "PagoPA",
                                        }
                                    },
                                    "CdtrAcct": {"Id": {"IBAN": "IT96K999999999900SRTPPAGOPA"}},
                                    "CdtrAgt": {"FinInstnId": {"Othr": {"Id": creditor_id, "SchmeNm": {"Cd": "BOID"}}}},
                                    "DbtrAgt": {"FinInstnId": {"BICFI": bic}},
                                    "PmtTpInf": {"LclInstrm": {"Prtry": "PAGOPA"}, "SvcLvl": [{"Cd": "SRTP"}]},
                                    "ReqdExctnDt": {"Dt": f"{execution_date}Z"},
                                    "RmtInf": {"Ustrd": ["TEST IS 12"]},
                                },
                                "RsltnRltdInf": {
                                    "Chrgs": [
                                        {
                                            "Agt": {"FinInstnId": {"BICFI": bic}},
                                            "Amt": {"ActiveOrHistoricCurrencyAndAmount": amount, "Ccy": "EUR"},
                                        }
                                    ]
                                },
                            }
