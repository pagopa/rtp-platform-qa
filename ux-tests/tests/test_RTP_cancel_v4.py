...
from test_RTP_submission_v4 import test_rtp_form_submission

_CANCEL_MODT_BUTTON = 'button:has-text("Cancella MODT v4.0")'
_CANCEL_PAID_BUTTON = 'button:has-text("Cancella PAID v4.0")'
