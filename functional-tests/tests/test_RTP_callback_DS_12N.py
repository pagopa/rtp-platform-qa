...
def test_fail_send_rfc_callback_wrong_certificate_serial_DS_12N_RJCR_compliant(
    ...
    4. Send an RTP
    5. Cancel the RTP (RFC - Request for Cancellation)
    6. Send DS12N callback with wrong BIC (MOCKSP01 instead of MOCKSP04)
    ...
    callback_data = build_rfc_callback_with_original_msg_id(
        lambda resource_id=None, original_msg_id=None: generate_callback_data_DS_12N_RJCR_compliant(
