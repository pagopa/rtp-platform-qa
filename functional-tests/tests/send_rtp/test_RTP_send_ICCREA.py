...
@allure.feature("RTP Send")
@allure.story("Service provider sends an RTP to a provider")
@allure.title("An RTP is sent to ICCREA service with activated fiscal code - through Web API V2")
@allure.tag("functional", "happy_path", "rtp_send", "iccrea")
@pytest.mark.send
@pytest.mark.happy_path
@pytest.mark.real_integration
@pytest.mark.iccrea
def test_send_rtp_to_iccrea_THROUGH_WEB_API_V2(creditor_service_provider_token_a):
